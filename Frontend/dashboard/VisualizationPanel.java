...
public class VisualizationPanel extends JPanel {
    ...
    public VisualizationPanel() {
        ...
        refreshButton.addActionListener(e -> refreshCurrentTabVisualization());
    ...
    private void refreshCurrentTabVisualization() {
        int selectedIndex = tabbedPane.getSelectedIndex();
        if (selectedIndex != -1) {
            int projectId = selectedIndex + 1;
            JPanel updatedPanel = createProjectPanel(projectId);
            tabbedPane.setComponentAt(selectedIndex, updatedPanel);
        }
    }
